...
import { AssignmentReturn, EventAvailable } from '@mui/icons-material';
...
const ReturnPolicy = () => {
    ...
    const POLICY_KEY = 'return_policy';
...
const response = await api.get('/accounts/about/', {
    ...
    // Using theme.palette.warning.main for a distinct color (e.g., orange/yellow)
    const pageColor = theme.palette.warning.main; 
        ...
        <Box sx={{ bgcolor: '#f4f6f8', py: { xs: 4, md: 6 }, minHeight: 'calc(100vh - 64px)' }}>
            <Container maxWidth="md">
                ...
                <Box textAlign="center" mb={5}>
                    <AssignmentReturn sx={{ fontSize: 60, mb: 1, color: pageColor }} />
